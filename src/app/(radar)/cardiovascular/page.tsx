...
interface MetricCardProps {
  ...
  value: string
  unit?: string
  status: "NORMAL" | "ABNORMAL" | "WARNING" | "GOOD" | "PRE-HTN"
  source: string
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-900">Cardiovascular System</h1>
        </div>
      </div>
