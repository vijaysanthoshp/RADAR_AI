...
interface MetricCardProps {
  ...
  value: string
  unit?: string
  status: "NORMAL" | "HIGH" | "WARNING" | "HIGH RISK" | "ELEVATED" | "STABLE" | "CHECK"
  source: string
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-900">Renal & Fluid System</h1>
        </div>
      </div>
      ...
      <Card className="relative overflow-hidden border-0 shadow-lg bg-white p-8">
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          <div className="bg-blue-50 p-6 rounded-full mb-6 relative">
            ...
            <Droplet className="h-12 w-12 text-blue-500 fill-blue-500" />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        />
        <MetricCard
          title="Fluid Volume Trend"
          value="Rapid Accumulation"
          status="HIGH RISK"
          source="Fluid Patch"
        ...
        />
        <MetricCard
          title="Vol-Dependent HTN"
          value="BP Elevated"
          status="CHECK"
          source="Smart BP Cuff"
